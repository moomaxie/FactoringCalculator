...
public abstract class AbstractModule extends DefaultModuleInfo implements Module
{
   ...
   *
   * @see org.jfree.base.modules.Module#getName()
   *
   ...
   * @see org.jfree.base.modules.Module#getDescription()
   *
   ...
   *
   * @see org.jfree.base.modules.Module#getProducer()
   *
   * @return the producer.
   */
   ...
   * @see org.jfree.base.modules.Module#getRequiredModules()
   *
