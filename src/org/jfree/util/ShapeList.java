...
/**
 * A table of {@link java.awt.Shape} objects.
 */
public class ShapeList extends AbstractObjectList {
    ...
    /**
     * Returns a {@link java.awt.Shape} object from the list.
     *
    ...
    /**
     * Sets the {@link java.awt.Shape} for an item in the list.  The list is expanded
     * if necessary.
     *
     * @param index  the index (zero-based).
     * @param shape  the {@link java.awt.Shape}.
     */
