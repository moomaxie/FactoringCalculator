...
/**
 * A table of {@link java.awt.Paint} objects.
 */
public class PaintList extends AbstractObjectList {
    ...
    /**
     * Returns a {@link java.awt.Paint} object from the list.
     *
    ...
    /**
     * Sets the {@link java.awt.Paint} for an item in the list.  The list is expanded if necessary.
     *
     * @param index  the index (zero-based).
     * @param paint  the {@link java.awt.Paint}.
     */
