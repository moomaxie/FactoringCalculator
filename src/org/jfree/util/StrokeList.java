...
/**
 * A table of {@link java.awt.Stroke} objects.
 *
...
public class StrokeList extends AbstractObjectList {
    ...
    /**
     * Returns a {@link java.awt.Stroke} object from the list.
     *
    ...
    /**
     * Sets the {@link java.awt.Stroke} for an item in the list.  The list is expanded if necessary.
     *
     * @param index  the index (zero-based).
