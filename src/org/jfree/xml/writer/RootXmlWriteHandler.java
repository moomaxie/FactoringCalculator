...
public abstract class RootXmlWriteHandler {
     ...
     * @throws org.jfree.xml.writer.XMLWriterException if no handler could be found for the given class.
     */
     ...
     * 
     * @throws java.io.IOException if an IOException occures.
     * @throws org.jfree.xml.writer.XMLWriterException if an object model related error occures during
     * the writing.
     */
     ...
     * 
     * @throws org.jfree.xml.writer.XMLWriterException if there is a writer exception.
     */
